...
//
#define SVM_MSR_PERMISSIONS_MAP_SIZE    SIZE_8KB

//
// See "SVM Related MSRs"
//
#define SVM_MSR_VM_CR                   0xc0010114
#define     VM_CR_DPD                   BIT0
#define     VM_CR_R_INIT                BIT1
#define     VM_CR_DIS_A20M              BIT2
